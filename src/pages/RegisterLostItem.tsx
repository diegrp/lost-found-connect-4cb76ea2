  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (existingFoundItems && existingFoundItems.length > 0) {
        toast.error(
          "Item já cadastrado como encontrado. Atualize o status do item existente ao invés de criar novo registro.",
          { duration: 5000 }
        );
        setLoading(false);
        return;
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Preencha as informações do item que você perdeu
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <Label htmlFor="date">Data em que perdeu *</Label>
                <Input
                  id="date"
                  type="date"
              ...
              <div>
                <Label htmlFor="location">Local onde perdeu</Label>
                <Input
                  id="location"
